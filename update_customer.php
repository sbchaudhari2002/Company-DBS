...
if(isset($_POST['done'])){
        ...
        $q = "UPDATE customer SET cid='$cid', cfirst_name='$cfirstname', clast_name='$clastname',
        cemail='$cemail', custusername='$cusername', contact='$cmobile', prodid='$prodid', qty='$qty' WHERE cid = $cid";
    ...
    <main>
        <section>
            <div class="container">
                ...
                <div class="border">
                    <h5 class="text-uppercase text-center my-4">Update Customer</h5>
                    <div>
