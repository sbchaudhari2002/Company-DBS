...
if(isset($_POST['done'])){
        ...
        $q = "UPDATE product SET proid='$productid', pro_name='$productname', pro_price='$productprice' WHERE proid=$productid";
    ...
    <main>
        <section>
            <div class="container">
                ...
                <div class="border">
                    <h5 class="text-uppercase text-center my-4">Update Product</h5>
                    <div>
