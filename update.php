...
if(isset($_POST['done'])){
        ...
        // $q = "UPDATE `employee` SET `empid`=$empid,`first_name`=$firstname,`last_name`=$lastname,`username`=$username,`pass`=$password,
        // `phone_number`=$mobile, `job_title`=$jobtitle,`salary`=$salary,`department_id`=$deptid,
        // `manager_id`=$mgrid,`address`=$address,`skills`=$skills WHERE `empid`=$empid";
            ...
            <div class="container">
                ...
                <div class="border">
                    ...
                    <div>
                        ...
                        <button class="btn btn-small btn-warning mx-auto my-4 col-lg-4 ml-auto"><a href="./employee_profile.php" class="text-white"><i class="fas fa-arrow-left mx-2"></i>Back to Home</a></button>
                        </div>
