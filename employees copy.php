                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <form action="" method="POST">
                                    <input class="form-check-input" type="radio" name="sf" id="lt" />
                                    <label class="form-check-label" for="lt">
                                        less than
                                    </label><input class="form-check-input" type="radio" name="sf" id="equals_to" checked />
                                    <label class="form-check-label" for="equals_to">
                                        Equals to
                                    </label><input class="form-check-input" type="radio" name="sf" id="gt" />
                                ...
                                // echo ' <select name="salary_filter">';
                                ...
                                //     $salary_filter = (isset($_POST['salary_filter']));

                                //     if ($salary_filter == 'less_than') {
                                //         $action = "employee_search_lt.php";
                                //     } else if ($salary_filter == 'equals_to') {
                                //         $action = "employee_search.php";
                                //     } else if ($salary_filter == 'greater_than') {
                            ...
                            <!-- <div class="col-md-9">
                                <form class="needs-validation" action="<?php echo $action; ?>" method="POST" novalidate>
                                    <div class="form-row">
                            ...
                            <!-- -------------------------------------- -->
                            <div class="col-md-9">
                                <form class="needs-validation" name="store" id="store" action="" method="POST" id="FORM_ID" novalidate>
                                    <select name="salary_filter">
                                        <option value="employee_search_lt.php">less than</option>
                                        <option value="employee_search.php">equals to</option>
                                        <option value="employee_search_gt.php">greater than</option>
                                    </select>
                                    <div class="form-row">
                                        <div class="col col-md-5">
                                            <input type="text" class="form-control" id="salary_input" placeholder="Salary Input" name="salary_input" required>
