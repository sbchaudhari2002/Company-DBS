...
<body>
    <main class="bg-lightgray">
        <div class="container-fluid">
            <section>
                <h4 class=" text-uppercase text-white text-center py-3 bg-dark">Employees with salary <= <?php echo $salary_input ?></h4>
                <div class="py-3">
                    <div class="m-2">
                        <table class="mx-auto bg-white">
                            ...
                            $q = "Select * from employee where salary >= $salary_input";
                    ...
                    <button class="btn btn-small btn-warning mx-auto my-4 col-lg-4 ml-auto"><a href="./employees.php" class="text-white"><i class="fas fa-arrow-left mx-2"></i>All Employees</a></button>
